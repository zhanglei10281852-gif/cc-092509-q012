...
- 许可义务登记与结算准备：按地域、产品线和销售里程碑跟踪许可合同报告义务，保存合同版本、适用资产、报告窗口、阈值与应付状态；合同修改可追溯生效但不能改变已锁定周期；对方报告重复导入不重复计提，缺项与超范围行自动生成待复核差异；确认后锁定周期，暂停或终止只影响后续窗口；应付金额可追溯到合同版本、原始报告与人工修正理由。
